...
//     localStorage.setItem('lastOrder', JSON.stringify(orderSummary));
//     console.log('✅ Order saved to localStorage:', orderSummary);
...
//             <p key={index}>
//               {product.title} × {product.quantity ?? 1} — ${product.price.toFixed(2)}
//             </p>
//           ))}
//         </div>
...
interface Props {
  onPlaceOrder: (e?: BaseSyntheticEvent) => Promise<void>;
}
