...
//       <div className="bg-[#333333]">
//         <section>
//           <nav className="container mx-auto flex flex-wrap md:flex-nowrap items-center justify-between py-4 px-4 md:px-2 h-auto md:h-[3.75rem] relative">
...
//             <ul
//               className={`
//                 flex flex-col md:flex-row gap-4 md:gap-5 items-center
//                 w-full md:w-auto
//                 bg-[#333333] md:bg-transparent
...
//                     to={item.path}
//                     className={({ isActive }) =>
//                       isActive ? "text-white font-semibold" : "text-[#999999]"
//                     }
//                   >
//                     {item.name}
//                   </NavLink>
          ...
          >
            ...
            <ul
              ...
              className={`
                ...
                ${menuOpen ? "max-h-[500px] px-4 py-4" : "max-h-0 px-4"}
              `}
            >
              {navItems.map((item, index) => (
                <li
